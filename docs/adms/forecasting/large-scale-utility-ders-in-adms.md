...
description: Configuration and forecasting for large-scale utility DERs that are unaffected by weather, including diesel generators and batteries, with details on data storage and adapters.
category: adms/forecasting
keywords: [utility scale DERs, ADMS, NMS, diesel generator, battery forecast, PF_DER_FORECAST]
source: user
created: 2026-02-05T05:30:19.470Z
updated: 2026-02-05T05:30:19.470Z
---
...
See also - [DER and Weather Zone Forecasts Overview](/docs/adms/forecasting/der-and-weather-zone-forecasts-overview)
- [Demand Response Groups](/docs/adms/forecasting/demand-response-groups-in-adms)
