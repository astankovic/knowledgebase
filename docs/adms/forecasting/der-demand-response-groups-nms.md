---
title: DER Demand Response Groups in NMS
description: This article describes how to configure demand response groups in NMS for forecasting and simulating load drops in distributed energy resources, including data mapping and external system integration.
category: adms/forecasting
keywords: [demand response groups, DR groups, DER forecasts, NMS, distributed energy resources, ADMS, load drop simulation]
source: user
created: 2026-02-06T19:55:37.438Z
updated: 2026-02-06T19:55:37.438Z
---
...
See also - [DER Weather Zone Forecasts](/docs/adms/forecasting/der-weather-zone-forecasts-nms)
- [Large Scale Utility DER Forecasts](/docs/adms/forecasting/der-large-scale-utility-forecasts-nms)
