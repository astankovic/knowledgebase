---
title: DER Weather Zone Forecasts in NMS
description: Configure and provide forecasts for weather-affected DER resources using weather zones in the Oracle Utilities Network Management System (NMS), including mapping to zones, profile selection, and temperature adjustments.
category: adms/forecasting
keywords: [weather zones, DER forecasts, NMS, distributed energy resources, ADMS, PF_WEATHER_ZONE]
source: user
created: 2026-02-05T05:21:44.191Z
updated: 2026-02-05T05:21:44.191Z
---

## Overview

A utility has the ability to provide forecast data for various types of DER resources that are present within the electrical network. The NMS categorizes DERs into the following forecast categories:
- Weather Affected DERs
- Utility Scale DERs
- Demand Response Groups

The following sections describe how to configure them and provide the required forecast data.
